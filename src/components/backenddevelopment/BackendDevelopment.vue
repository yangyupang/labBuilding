  ...
  <div>
    <div class="backend">
      ...
      <div class="backend-title">
        <span>{{backendlist.classify_name}}</span>
        <span>更多></span>
      </div>
      <!-- 后端开发 classicallist.courses -->
      <div class="backend-courses">
        ...
        <div class="course-img">
          <!-- 课程小图 -->
          <div class="course-item" v-for="(item,index) in backendlist.courses" :key="index">
            <div class="item-img">
  ...
  methods: {
    ...
    getDackendData() {
      this.$axios
        ...
        .then(res => {
          this.backendlist = res[3];
          this.pictureurl = res[3].recommend_course.picture_url;
